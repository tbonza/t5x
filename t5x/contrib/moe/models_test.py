...
class ModelsTest(absltest.TestCase):
    ...
    def test_expert_metrics(self):
        ...
        actual_computed_metrics = {k: v.compute() for k, v in actual_metrics.items()}
    ...
    def test_decoder_only_model(self):
        ...
        with mock.patch.object(models.MoeDecoderOnlyModel, "__init__", new=mock_init):
        ...
        self.assertContainsSubset(
            {
                ...
                "experts/expert_usage": AveragePerStep(total=jnp.array(0.9), steps=1),
                ...
                "cross_ent_loss": AveragePerStep(steps=1, total=jnp.array(5.0590305)),
