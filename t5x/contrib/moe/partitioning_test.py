...
def create_multioptimizer_train_state(
    ...
    mlp_vars = flax.traverse_util.ModelParamTraversal(lambda path, _: not _is_mlp(path))
    non_mlp_vars = flax.traverse_util.ModelParamTraversal(lambda path, _: _is_mlp(path))
